# Getting help with jsontools

Thanks for using jsontools. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/jsontools/issues) to make sure the 
